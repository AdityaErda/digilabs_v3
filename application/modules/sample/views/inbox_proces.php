          ...
          <form id="form_inbox">
            ...
            <div class="card">
              ...
              <div class="card-header bg-primary">
                <h3 class="card-title">Detail Surat <?= $inbox['transaksi_nomor'] ?></h3>
              ...
              <div class="card-body row">
                ...
                <input type="text" id="header_menu" name="header_menu" style="display:none" value="<?= $this->input->get('header_menu') ?>">
                <input type="text" id="menu_id" name="menu_id" style="display:none" value="<?= $this->input->get('menu_id') ?>">
            ...
            <div class="card">
                    ...
                    <div class="row">
                      <div class="form-group row col-md-12">
                        <div class="input-group col-12">
                          ...
                          <input type="text" id="transaksi_detail_status" name="transaksi_detail_status" value="<?= $detail['transaksi_detail_status'] ?>" style="display:none">
                          <input type="text" class="form-control" id="item_judul" name="item_judul" plac readonlyeholder="Judul" value="<?= $detail['transaksi_detail_judul'] ?>" style=" border:none;border-bottom: 1px solid #1890ff;padding: 5px 10px;  outline: none;" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-6">
                        <div class="form-group row col-12" id="div_template_logsheet">
                          ...
                          <div class="input-group col-md-8">
                            ...
                            <!-- <div class="form-group row col-3" id="div_id_template_logsheet" style="display:none"> -->
                            <!-- <a href="javascript:void(0);" onclick="preview_template(this.value)" id="id_template_logsheet" name="id_template_logsheet">Preview</a> -->
                            <!-- </div> -->
                            <div class="form-group row col-3" id="div_id_download_logsheet" style="display:none">
                        ...
                        <div class="form-group row col-12" id="div_file_excel">
                          ...
                          <div class="col-md-8">
                            ...
                            <span style="color:red">note : format yang didukung .xls</span>
                        ...
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-md-8">
                            <input type="text" id="jenis_nama" name="jenis_nama" value="<?= $detail['jenis_nama'] ?>" class="form-control">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Jenis Pekerjaan</label>
                          <div class="input-group col-md-8">
                            <input type="text" id="sample_pekerjaan_nama" name="sample_pekerjaan_nama" class="form-control" value="<?= $detail['sample_pekerjaan_nama'] ?>">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Jumlah Sample</label>
                          <div class="input-group col-8">
                            <input type="text" id="transaksi_detail_jumlah" name="transaksi_detail_jumlah" class="form-control" value="<?= $detail['transaksi_detail_jumlah']; ?>" onkeypress="return numberOnly(event)">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Identitas Sample</label>
                          <div class="input-group col-8">
                            <input type="text" id="identitas_nama" name="identitas_nama" placeholder="Identitas Sample" class="form-control" value="<?= $detail['transaksi_detail_identitas']; ?>">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Parameter Sample</label>
                          <div class="input-group col-8">
                            <input type="text" id="transaksi_detail_parameter" name="transaksi_detail_parameter" placeholder="Parameter Sample" class="form-control" value="<?= $detail['transaksi_detail_parameter'] ?>" onkeypress="return numberOnly(event)">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                      ...
                      <div class="col-6">
                        ...
                        <?php if ($detail['transaksi_detail_file'] != '') : ?>
                          <div class="form-group row col-12">
                            <label class="col-md-4"></label>
                            <div class="col-8">
                              <a class="btn btn-info form-control col-4" href="javascript:;" data-toggle="modal" data-target="#modal_lihat" onclick="fun_lihat('<?= $detail['transaksi_detail_file'] ?>')">Preview</a>
                              <a class="btn btn-info form-control col-4" target="_blank" href="<?= base_url() . 'sample/request/downloadFile?file=' . $detail['transaksi_detail_file'] ?>">Download</a>
                            </div>
                            <img src="<?= base_url() . 'document/' . $detail['transaksi_detail_file'] ?>" style="width:400px;border:1px black">
                          </div>
                        <?php endif; ?>
                      </div>
                      <!-- Kanan -->
              ...
              <div class="card-footer">
                <button type="button" id="kembali" class="btn btn-default border-dark" onclick="kembali_inbox()">Kembali</button>
                ...
                <button type="button" class="btn btn-success float-right" id="progress" style="display: none" onclick="fun_cara_close('<?= $_GET['transaksi_detail_id'] ?>','<?= $_GET['transaksi_id'] ?>','<?= $_GET['transaksi_detail_status'] ?>','<?= $_GET['transaksi_status'] ?>')" data-target="#modal_cara_close" data-toggle="modal">On Progress</button>
