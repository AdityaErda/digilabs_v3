            ...
            <div class="card card-success">
              ...
              <form id="form_detail">
                <div class="card-body">
                  ...
                  <input type="text" name="logsheet_multiple_id" id="logsheet_multiple_id" style="display:none">
                  <!-- <input type="text" name="transaksi_detail_status" id="transaksi_detail_status" style="display:none ;"> -->
                  <!-- <input type="text" name="transaksi_status_detail" id="transaksi_status_detail" style="display:none ;"> -->
                  ...
                  <!-- Table -->
                  <button type="button" class="btn btn-success" onClick="func_pilih_checkbox_sample()">Proses</button>
                </div>
              </form>
            </div>
          </div>
