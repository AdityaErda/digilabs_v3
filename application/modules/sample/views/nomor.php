                    ...
                    <div class="form-group col-md-3">
                      ...
                      <div class="input-group col-md-12">
                        <select class="form-control select2" name="status_cari" id="status_cari">
                          ...
                          <!-- <option value="18">Clossed</option> -->
                        </select>
                      </div>
                    </div>
                    <div class="form-group col-md-3">
                            ...
                            <div class="col-12">
                              <!-- <div class="form-group row col-md-12">
                                ...
                                <div class="input-group col-md-8">
                                  <select class="form-control select2" id="klasifikasi_id" name="klasifikasi_id">
                                  </select>
                                </div>
                              </div> -->
                              <div class="form-group row col-md-12">
                                    ...
                                    <tr>
                                      ...
                                      options:{
                                        ...
                                        <div id="toolbar" align="right">
                                          <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="fun_hapus_sample()">Delete</a>
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                <form id="form_modal_cara_close">
                                  <!-- <input type="hidden" id="jadwal_id" name="jadwal_id" value=""> -->
                                  <input type="text" id="status_transaksi" name="status_transaksi" value="" style="display:none">
                                  <input type="text" id="id_transaksi_rutin" name="id_transaksi_rutin" value="" style="display:none">
                                  <input type="text" id="id_transaksi" name="id_transaksi" value="" style="display:none">
                                  <input type="text" id="is_multiple" name="is_multiple" style="display:none">
                                  <div class="modal-body">
                                    <div class="form-group row col-md-12">
