          ...
          <form id="form_request">
            ...
            <div class="card">
              ...
              <div class="card-body row">
                <input type="text" id="is_new" name="is_new" style="display: none;" value="1">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="form-group row col-md-12" id="div_reject" style="display:none">
                      <label class="col-md-4">Alasan Reject</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" id="transaksi_reject_alasan" name="transaksi_reject_alasan" value="" placeholder="Alasan Reject" readonly>
                      </div>
                    </div>
                  ...
                  <?php foreach ($sample_detail as $key => $detail) : ?>
                    <div class="div_item_baru">
                      <div class="row">
                        <div class="form-group row col-md-12">
                          <div class="col-11">
                            <input id="transaksi_detail_id_<?= $key ?>" name="transaksi_detail_id[]" value="<?= $detail['transaksi_detail_id']; ?>" style="display:none">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          ...
                          <div class="form-group row col-12">
                            <label for="" class="col-md-4">Jumlah Parameter</label>
                            <div class="col-8">
                        ...
                        <div class="col-6">
                          ...
                          <div class="form-group row col-12">
                            ...
                            <div class="col-8">
                              <input type="file" name="transaksi_detail_file[]" id="transaksi_detail_file_<?= $key ?>" class="form-control" accept="image/jpeg,image/png,image/gif,image/bmp">
                            </div>
                          </div>
                          <div class="form-group row col-12">
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-custom btn-primary" id="edit">Edit</button>
              <button type="button" class="btn btn-custom btn-success float-right" id="ajukan">Ajukan</button>
