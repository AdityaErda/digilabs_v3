          ...
          <form id="form_logsheet">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_jenis" name="transaksi_jenis" placeholder="Judul" value="<?= $inbox_detail[0]['jenis_nama'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Tanda</label>
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_tanda" name="transaksi_tanda" placeholder="Judul" value="<?= $inbox_detail[0]['transaksi_detail_identitas'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Catatan</label>
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_catatan" name="transaksi_catatan" value="<?= $inbox_detail[0]['transaksi_detail_catatan'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Sertifikat</label>
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_sertifikat" name="transaksi_sertifikat" value="<?= $inbox['transaksi_nomor'] ?>" readonly>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-6">
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_no_lab" name="transaksi_no_lab" value="<?= $inbox_detail[0]['transaksi_detail_nomor_sample'] ?>">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          ...
                          <input type="text" class="form-control float-right tanggal" id="transaksi_tgl_terima" name="transaksi_tgl_terima">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          ...
                          <input type="text" class="form-control float-right tanggal" id="transaksi_tgl_sampling" name="transaksi_tgl_sampling">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          ...
                          <input type="text" class="form-control float-right waktu" id="transaksi_jam_sampling" name="transaksi_jam_sampling" value="<?= date('H:i:s') ?>">
                        </div>
                      </div>
                    </div>
            ...
            <div class="card">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-md-8">
                            <input type="text" class="form-control" id="log_jenis_nama" name="log_jenis_nama[0]" placeholder="Jenis Uji" value="<?= $inbox_detail[0]['jenis_nama'] ?>">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Satuan</label>
                          <div class="input-group col-md-8">
                            <input type="text" class="form-control" id="log_jenis_unit" name="log_jenis_unit[0]" placeholder="Satuan">
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
                      ...
                      <div class=" form-group col-12 row">
                        ...
                        <table id="table" class="table table-bordered table-striped" width="100%">
                          ...
                          <tbody class="tbody" id="tbody">
                            <input type="text" id="logsheet_urut" name="logsheet_urut[0]" value="1">
                            <input type="text" id="logsheeet_detail_id" name="logsheet_detail_id[0]" value="<?= create_id() ?>" class="logsheet_detail_id">
                            <tr class="tr" id="tr">
                              <!-- <input type="text" id="logsheet_isi_urut" name="logsheet_isi_urut" value="1"> -->
                              <td class="td">
                                <input type="text" id="param_urut_1" name="param_urut[0][]" value="1">
                              ...
                              <td class="td"><button type="button" class="btn btn-danger" id="remove_log_detail">Hapus</button></td>
                            </tr>
                          </tbody>
                        </table>
                        <!-- </form> -->
              ...
              <div class="card-footer">
                ...
                <button type="button" id="simpan" class="btn btn-success">Proses</button>
              </div>
            </div>
          </form>
          <!-- modal -->
