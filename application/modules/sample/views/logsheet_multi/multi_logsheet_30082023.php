                        ...
                        <div class="col-6">
                          <div class="form-group row col-12">
                            ...
                            <div class="input-group col-md-8">
                              ...
                              <input style="display:none;" type="text" name="logsheet_id[<?= $val_md['transaksi_detail_id'] ?>]" value="<?= rand(); ?>">
                        ...
                        <?php foreach ($template_detail as $key_td => $val_td) :  ?>
                          ...
                          <div class="card-body">
                            <div class="form-group col-12 row">
                              <input type="text" name="rumus_metode[<?=$val_md['transaksi_detail_id']?>][]" id="rumus_metode_<?= $val_td['template_logsheet_detail_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>" value="<?= $val_td['metode'] ?>" style="display:none">
                              <input type="text" name="rumus_satuan[<?=$val_md['transaksi_detail_id']?>][]" id="rumus_satuan_<?= $val_td['template_logsheet_detail_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>" value="<?= $val_td['satuan_sample'] ?>" style="display:none">

                              <input type="text" name="rumus_id[<?=$val_md['transaksi_detail_id']?>][]" id="rumus_id_<?= $val_td['template_logsheet_detail_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>" value="<?= $val_td['rumus_id'] ?>" style="display:none">
                              <input type="text" name="rumus_nama[<?=$val_md['transaksi_detail_id']?>][]" id="rumus_nama_<?= $val_td['template_logsheet_detail_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>" value="<?= $val_td['rumus_nama'] ?>" style="display:none">
                              <table id="<?= $val_td['rumus_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>" class="table table-bordered table-striped datatables" width="100%">
                                ...
                                <tbody id="body_<?= $val_td['rumus_id'] ?>_<?= $val_md['transaksi_detail_id'] ?>">
                                  <tr>
                                    <td>
                                      1
                                      <input type="text" name="logsheet_detail_urut[<?=$val_md['transaksi_detail_id']?>][]" id="logsheet_detail_urut" value="1" style="display:none">
                                      <input type="text" value="1" name="logsheet_detail_urut_baris[<?=$val_md['transaksi_detail_id']?>][]" id="logsheet_detail_urut_baris" style="display:none">'
                                    </td>
                                    <?php foreach ($detail_rumus as $key_dr => $val_dr) :
                                      ...
                                      if ($val_dr['rumus_detail_input'] != null) {
                                        ?>
                                        <td>
                                          <input type="text" id="rumus_detail_isi_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_isi[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_detail_input'] ?>" readonly>

                                          <input type="text" id="rumus_detail_id_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_id[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_detail_id'] ?>" readonly style="display: none;">

                                          <input type="text" id="rumus_detail_nama_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_nama[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_detail_nama'] ?>" readonly style="display: none;">

                                          <input type="text" id="rumus_jenis_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_jenis[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_jenis'] ?>" readonly style="display: none;">

                                          <input type="text" id="rumus_detail_urut_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_urut[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_detail_urut'] ?>" readonly style="display: none;">

                                          <input type="text" id="rumus_detail_template_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_template[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control" value="<?= $val_dr['rumus_detail_template'] ?>" readonly style="display: none;">

                                        </td>
                                      <?php } else { ?>
                                        <td>
                                          <input type="number" id="rumus_detail_isi_<?= $val_dr['rumus_detail_id'] ?>_<?= $key_md ?>" name="rumus_detail_isi[<?=$val_md['transaksi_detail_id']?>][<?=$val_td['rumus_id']?>][]" class="form-control">
                                    ...
                                    <?php endforeach; ?>
                                    <td>
                                      <input type="text" class="form-control hasil_<?= $val_td['rumus_id'] ?>" id="hasil_<?= $val_td['rumus_id'] ?>_<?= $key_md ?>" name="hasil_<?= $val_td['rumus_id'] ?>[]  " onclick="fun_hitung(`<?= $val_td['rumus_id'] ?>`,<?= $key_md ?>);" readonly placeholder="klik u/ hasil">
                                      <input type="text" class="form-control rumus_hasil_<?= $val_td['rumus_id'] ?>" id="rumus_hasil_<?= $val_td['rumus_id'] ?>_<?= $key_md ?>" name="rumus_hasil[<?=$val_md['transaksi_detail_id']?>][]" style="display:none">
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
