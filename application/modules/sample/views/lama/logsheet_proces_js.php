<script>
  ...
  function fun_detail_rumus(id,satuan,metoda) {
    ...
    $.getJSON('<?= base_url() ?>/master/perhitungan_sample/getDetailRumusSampleTemplate', {
      ...
      // body += '</form>';
      header += '<th>Metoda</th><th>Satuan</th><th>Hasil</th><th>Aksi</th></tr>';
      body += '\
      <td><input type="text" id="rumus_metoda_'+id+'" name="rumus_metoda[]" value="'+metoda+'" class="form-control rumus_metoda"></td>\
      <td><input type="text" id="rumus_satuan_'+id+'" name="rumus_satuan[]" value="'+satuan+'" class="form-control rumus_satuan"></td>\
      <td><input type="text" class="form-control hasil_' + id + '" id="hasil_' + id + '" name="hasil_' + id + '[1]" readonly onclick="fun_hitung(`' + id + '`);fun_store_history(`' + id + '`)" readonly placeholder="klik u/ hasil">\
      <input type="text" class="form-control" id="rumus_detail_hasil_' + id + '" name="rumus_detail_hasil[]" style="display:none">\
      </td>\
      <td width="20px">\
      <a href="javascript:void(0);" id="' + id + '" onclick="add_simplo(this.id,`'+satuan+'`,`'+metoda+'`)"><i class="fa fa-plus" style="color:green"></i></a>\
      <br>\
      </td></tr>';
      footer += '<td colspan="' + (json.length + 3) + '"><p>Rata-rata </p></td><td><input class="form-control" placeholder="klik untuk rata-rata" type="text" id="rata_' + id + '" name="rata_rata[]" onclick="fun_average(`' + id + '`)" readonly style="display:none"></td></tr>';

      footer_adbk += '<td colspan="' + (json.length + 3) + '"><p>Rata-rata </p></td><td><input class="form-control" placeholder="klik untuk nilai adbk" type="text" id="nilai_adbk_' + id + '" name="nilai_adbk[]" onclick="fun_nilai_adbk(`' + id + '`)" readonly style="display:none"></td></tr>';
...
function add_simplo(id,satuan,metoda) {
  ...
  $.getJSON('<?= base_url() ?>/master/perhitungan_sample/getDetailRumusSampleTemplate', {
    ...
    header += '<th>Metoda</th><th>Satuan</th><th>Hasil</th><th>Aksi</th></tr>';
    body += '\
    <td><input type="text" id="rumus_metoda_'+id+'_'+jumlah+'" name="rumus_metoda[]" value="'+metoda+'" class="form-control rumus_metoda"></td>\
    <td><input type="text" id="rumus_satuan_'+id+'_'+jumlah+'" name="rumus_satuan[]" value="'+satuan+'" class="form-control rumus_satuan"></td>\
    <td>\<input type="text" class="form-control hasil_' + id + '" id="hasil_' + id + '_' + jumlah + '" name="hasil_' + id + '[' + jumlah + ']" readonly placeholder="klik u/ hasil">\
    <br>\
    ...
    footer += '<td colspan="' + (json.length + 3) + '"><p>Rata-rata </p></td><td><input class="form-control" placeholder="klik untuk rata-rata" type="text" id="rata_' + id + '_' + jumlah + '" name="rata_rata[]" onclick="fun_average(`' + id + '`)" readonly></td></tr>';

    footer_adbk += '<td colspan="' + (json.length + 3) + '"><p>Nilai ADBK </p></td><td><input class="form-control" placeholder="klik untuk nilai_adbk" type="text" id="nilai_adbk_' + id + '_' + jumlah + '" name="nilai_adbk[]" onclick="fun_nilai_adbk(`' + id + '`)" readonly></td></tr>';
