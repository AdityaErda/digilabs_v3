          ...
          <form id="form_inbox">
                  ...
                  <div class="row">
                    <div class="col-6">
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          <?php
                          switch ($inbox['transaksi_kecepatan_tanggap']) {
                            case 'Biasa':
                              $kt = 'Biasa';
                              break;
                            case 'Segera':
                          ...
                          ?>
                          <input type="text" class="form-control" id="transaksi_kecepatan_tanggal" name="transaksi_kecepatan_tanggap" value="<?= $kt ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          ...
                          ?>
                          <input type="text" name="transaksi_sifat" id="transaksi_sifat" class="form-control" value="<?= $ts ?>" readonly>
                        </div>
                      </div>
                    </div>
            ...
            <div class="card">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group row col-md-12">
                        ...
                        <div class="input-group col-12">
                          <input id="transaksi_detail_id_temp_<?= $key ?>" name="transaksi_detail_id_temp[]" value="<?= $detail['transaksi_detail_id'] ?>" style="display:none" class="transaksi_detail_id_temp">
                          <input id="transaksi_detail_id_<?= $key ?>" name="transaksi_detail_id[]" value="<?= create_id(); ?>" style="display:none" class="transaksi_detail_id">
                          <input type="text" id="transaksi_detail_status_<?= $key ?>" name="transaksi_detail_status[]" value="<?= $detail['transaksi_detail_status'] ?>" style="display:none">
                          <input type="text" class="form-control" id="item_judul" name="item_judul[]" readonly placeholder="Judul" value="<?= $detail['transaksi_detail_judul'] ?>" style=" border:block;border-bottom: 1px solid #1890ff;padding: 5px 10px;  outline: block;">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        <!-- <div class="form-group row col-12 div_template_logsheet" id="div_template_logsheet_<?= $key ?>">
                          <label class="col-md-4">Template</label>
                          <div class="input-group col-md-8">
                            <select id="template_logsheet_id_<?= $detail['transaksi_detail_id'] ?>" name="template_logsheet_id[]" class="form-control select2 template_logsheet_id"></select>
                          </div>
                        </div> -->
                        <div class="form-group row col-12">
                          <label class="col-md-4">Jenis Sample</label>
                          <div class="input-group col-md-8">
                            <input type="text" id="jenis_id_<?= $key ?>" name="jenis_id[]" value="<?= $detail['jenis_id'] ?>" class="form-control jenis_id" style="display: none;">
                            <input type="text" id="jenis_nama_<?= $key ?>" name="jenis_nama[]" value="<?= $detail['jenis_nama'] ?>" class="form-control">
                          </div>
                        </div>
                        <div class="form-group row col-12">
                          <label class="col-md-4">Jenis Pekerjaan</label>
                          <div class="input-group col-md-8">
                            <input type="text" id="sample_pekerjaan_nama_<?= $key ?>" name="sample_pekerjaan_nama[]" class="form-control" value="<?= $detail['sample_pekerjaan_nama'] ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-8">
                            <input type="text" id="transaksi_detail_jumlah_<?= $key ?>" name="transaksi_detail_jumlah[]" class="form-control" value="<?= $detail['transaksi_detail_jumlah']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-8">
                            <input type="text" id="identitas_nama_<?= $key ?>" name="identitas_nama[]" placeholder="Identitas Sample" class="form-control" value="<?= $detail['transaksi_detail_identitas']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-8">
                            <input type="text" id="transaksi_detail_parameter_<?= $key ?>" name="transaksi_detail_parameter[]" placeholder="Parameter Sample" class="form-control" value="<?= $detail['transaksi_detail_parameter'] ?>">
                          </div>
                        </div>
                      ...
                      <div class="col-6">
                        ...
                        <div class="form-group row col-12">
                          ...
                          <div class="input-group col-8">
                            <a class="btn btn-info" href="javascript:;" data-toggle="modal" data-target="#modal_lihat" onclick="fun_lihat('<?= $detail['transaksi_detail_file'] ?>')">Preview</a>
                            <br>&nbsp;
                            <a class="btn btn-info" target="_blank" href="<?= base_url() . 'sample/request/downloadFile?file=' . $detail['transaksi_detail_file'] ?>">Download</a>
                            <br>&nbsp;
                            <br />
              ...
              <div class="card-footer">
                ...
                <!-- <button type="button" class="btn btn-success float-right" id="progress" style="display: none" onclick="fun_cara_close('<?= $_GET['transaksi_detail_id'] ?>','<?= $_GET['transaksi_id'] ?>','<?= $_GET['transaksi_status'] ?>')" data-target="#modal_cara_close" data-toggle="modal">On Progress</button> -->

                <!-- <button type="button" class="btn btn-success float-right" id="sample_log" style="display: none" onclick="fun_cara_close('<?= $_GET['transaksi_detail_id'] ?>','<?= $_GET['transaksi_id'] ?>','<?= $_GET['transaksi_detail_status'] ?>','<?= $_GET['transaksi_status'] ?>')" >Raw Data</button> -->
