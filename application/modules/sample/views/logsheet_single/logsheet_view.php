          ...
          <form id="form_logsheet">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                ...
                <?php if($_GET['transaksi_detail_status']=='9'){ ?>
                <button type="button" id="simpan" class="btn btn-success">Review</button>
                <button type="button" id="revisi" class="btn btn-info">Revisi</button>
                <button type="button" id="reject" class="btn btn-danger">Reject</button>
                <?php } else if($_GET['transaksi_detail_status']=='10') { ?>
                <button type="button" id="print_logsheet" class="btn btn-info">Cetak LogSheet</button>
                <button type="button" id="print_sertifikat" class="btn btn-danger">Cetak Sertifikat</button>
                <?php } ?>
              </div>
            </div>
          </form>
