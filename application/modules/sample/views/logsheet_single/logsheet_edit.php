            ...
            <div class="card">
              ...
              <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group row col-12">
                            ...
                            <div class="input-group col-md-8">
                              <input type="text" class="form-control" id="log_jenis_nama" name="log_jenis_nama[0]" placeholder="Jenis Uji" value="<?=$value['logsheet_detail_nama']?>">
                            </div>
                          </div>
                          <div class="form-group row col-12">
                            <label class="col-md-4">Satuan</label>
                            <div class="input-group col-md-8">
                              <input type="text" class="form-control" id="log_jenis_unit" name="log_jenis_unit[0]" placeholder="Satuan" value="<?=$value['logsheet_detail_unit']?>">
                            </div>
                          </div>
                          <div class="form-group row col-12">
                            <label class="col-md-4">Deskripsi</label>
                            <div class="input-group col-md-8">
                              <textarea name="log_deskripsi[0]" id="log_deskripsi" cols="30" rows="3" class="form-control" placeholder="Deskripsi Sample"><?=$value['logsheet_detail_deskripsi']?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="form-group row col-12">
                            ...
                            <div class="input-group col-md-8">
                              <input type="text" class="form-control" id="log_metoda" name="log_metoda[0]" placeholder="Metoda" value="<?=$value['logsheet_detail_metoda']?>">
                            </div>
                          </div>
                          <div class="form-group row col-12">
                              ...
                              <tbody class="tbody" id="tbody">
                                ...
                                <tr class="tr" id="tr">
                                  <td class="td">
                                    ...
                                    <input type="text" class="form-control" id="urut" name="urut[0][]" value="1" readonly>
                                  </td>
                                  <td class="td">
                                    <input type="text" id="param_urut_1" name="param_urut[0][]" value="2" style="display:none">
                                    <input type="text" class="form-control" id="vol_orsat" name="vol_orsat[0][]">
                                  </td>
                                  <td class="td">
                                    <input type="text" id="param_urut_1" name="param_urut[0][]" value="3" style="display:none">
                                    <input type="text" class="form-control" id="vol_sisa_gas" name="vol_sisa_gas[0][]">
                                  </td>
                                  <td class="td">
                                    <input type="text" id="param_urut_1" name="param_urut[0][]" value="4" style="display:none">
                                    <input type="text" class="form-control" id="hasil" name="hasil[0][]">
                                  </td>
                ...
                <div class="card-footer">
                  ...
                  <button type="button" id="simpan" class="btn btn-success">Olah Data</button>
                </div>
              </div>
            </form>
            <!-- modal -->
