        ...
        <div class="col-12">
          <form id="form_approved">
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-custom btn-success float-right" id="approved">Approved</button>
...
<div class="modal fade" id="modal_agreement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Note Approved</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form id="form_agreement">
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <div class="form-group row col-12">
                <label class="col-md-4">Note Approved </label>
                <div class="input-group col-md-8">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-custom btn-secondary" data-dismiss="modal" id="close_approved">Close</button>
          <button type="button" class="btn btn-custom btn-success" id="simpan_approved">Approved</button>
          <button class="btn btn-primary" type="button" id="loading_approved" disabled style="display: none;">
            <img src="<?php echo site_url('assets_tambahan/ext_img/loading_page_resize_2.gif') ?>" alt="" style="width:30px">
            Loading...
          </button>
        </div>
