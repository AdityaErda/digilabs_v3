          ...
          <form id="form_lab">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group row col-12">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control required disabled" id="transaksi_judul" name="transaksi_judul" placeholder="Judul" value="">
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Kecepatan Tanggap</label>
                        <div class="col-md-8">
                          <select name="transaksi_kecepatan_tanggap" id="transaksi_kecepatan_tanggap" class="select2 form-control disabled">
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="col-md-8">
                          <select name="transaksi_klasifikasi_id" id="transaksi_klasifikasi_id" class="select2 form-control disabled"></select>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Sifat</label>
                        <div class="col-md-8">
                          <select name="transaksi_sifat" id="transaksi_sifat" class="select2 form-control disabled">
                            <option value="Biasa">Biasa</option>
                    ...
                    <div class="col-6">
                      <div class="form-group row col-12">
                        ...
                        <div class="col-md-8">
                          ...
                          <select name="transaksi_drafter" id="transaksi_drafter" class="select2 form-control disabled" onchange="gantiDrafter(this.value)"></select>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        ...
                        <div class="col-md-8">
                          ...
                          <select name="transaksi_reviewer" id="transaksi_reviewer" class="select2 form-control disabled" onchange="gantiReviewer(this.value)"></select>
                        </div>
                      </div>
                      <div class=" form-group row col-12">
                        ...
                        <div class="col-md-8">
                          ...
                          <select name="transaksi_approver" id="transaksi_approver" class="select2 form-control disabled" onchange="gantiApprover(this.value)"></select>
                        </div>
                      </div>
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="col-md-8">
                          ...
                          <select name="transaksi_tujuan" id="transaksi_tujuan" class="select2 form-control disabled" onchange="gantiTujuan(this.value)"></select>
                        </div>
                      </div>
                    </div>
                    <!-- Kanan -->
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group row col-md-12">
                      ...
                      <div class="col-md-8">
                        <select class="form-control select2 required disabled" id="peminta_jasa_id" name="peminta_jasa_id">
                        </select>
                      </div>
                    </div>
                    <div class="form-group row col-md-12">
                      ...
                      <div class="col-md-8">
                        ...
                        <select name="transaksi_detail_pic_pengirim" id="transaksi_detail_pic_pengirim" class="select2 form-control disabled" onchange="gantiPICPengirim(this.value)"></select>
                      </div>
                    </div>
                    <div class="form-group row col-md-12">
                      <label class="col-md-4">PIC Telepon / WhatsApp</label>
                      <div class="col-md-8">
                        <input type="text" class="form-control disabled" id="transaksi_detail_pic_telepon" name="transaksi_detail_pic_telepon" value="<?= $session['user_no_hp'] ?>" placeholder="Telp PIC" onkeypress="return numberOnly(event)">
                      </div>
                    </div>
                    <div class="form-group row col-md-12">
                      <label class="col-md-4">Ext Pengirim Sample </label>
                      <div class="col-md-8">
                        <input type="text" class="form-control required disabled" id="transaksi_detail_ext_pengirim" name="transaksi_detail_ext_pengirim" value="" placeholder="Ext Pengirim Sample" onkeypress="return numberOnly(event)">
                      </div>
                    </div>
                      ...
                      <div class="row ">
                        <div class="form-group row col-md-12">
                          <div class="col-11">
                            ...
                            <input required type="text" class="form-control disabled" id="item_judul_<?= $key ?>" name="item_judul[]" placeholder="Judul" value="<?= $detail['transaksi_detail_judul'] ?>" style=" border:none;border-bottom: 1px solid #1890ff;padding: 5px 10px;  outline: none;">
                          </div>
                          <div class="col-1">
                            <?php if ($this->input->get('status') == '4') : ?>
                              <button class="btn btn-danger btn-custom remove_item" type="button">Hapus</button>
                            <?php else : ?>
                              <button class="btn btn-default form-control" type="button" data-toggle="collapse" data-target="#div_item_<?= $key ?>" aria-expanded="false" aria-controls="div_item_<?= $key ?>"><i class="fa fa-angle-down"></i></button>
                            <?php endif ?>
                          </div>
                        </div>
                      </div>
                      <div class="row collapse <?php if ($this->input->get('status') != '3') echo 'show'; ?>" id="div_item_<?= $key ?>">
                        <!-- Kiri -->
                        <div class="col-6">
                          <div class="form-group row col-12">
                            <label class="col-md-4">Jenis Sample</label>
                            <div class="col-md-8">
                              <select name="jenis_id[]" id="jenis_id_<?= $key ?>" class="form-control select2 disabled">
                          ...
                          <div class="form-group row col-12">
                            ...
                            <div class="col-md-8">
                              <select name="jenis_pekerjaan_id[]" id="jenis_pekerjaan_id_<?= $key ?>" class="form-control select2 disabled">
                          ...
                          <div class="form-group row col-12">
                            ...
                            <div class="col-8">
                              <input type="text" id="transaksi_detail_jumlah_<?= $key ?>" name="transaksi_detail_jumlah[]" class="form-control disabled" value="<?= $detail['transaksi_detail_jumlah']; ?>" onkeypress="return numberOnly(event)">
                            </div>
                          </div>
                          <div class="form-group row col-12">
                            <label class="col-md-4">Identitas Sample</label>
                            <div class="col-8">
                              <input type="text" id="transaksi_detail_identitas_<?= $key ?>" name="transaksi_detail_identitas[]" placeholder="Identitas Sample" class="form-control disabled" value="<?= $detail['transaksi_detail_identitas']; ?>">
                          ...
                          <div class="form-group row col-12">
                            ...
                            <div class="col-8">
                              <input type="text" id="transaksi_detail_parameter_<?= $key ?>" name="transaksi_detail_parameter[]" placeholder="Parameter Sample" class="form-control disabled" value="<?= $detail['transaksi_detail_parameter'] ?>" onkeypress="return numberOnly(event)">
                            </div>
                          </div>
                          <div class="form-group row col-12">
                            <label class="col-md-4">Deskripsi Parameter Uji / Kalibrasi</label>
                            <div class="col-8">
                              <textarea name="transaksi_detail_deskripsi_parameter[]" id="transaksi_detail_deskripsi_parameter_<?= $key ?>" cols="3" rows="3" class="form-control disabled" placeholder="Analisa Cu, Pb, Uji Aplikasi, Analisa Kimia / Kalibrasi Suhu Range 10 Derajat C, 20 Derajat C"><?= $detail['transaksi_detail_deskripsi_parameter'] ?></textarea>
                            </div>
                          </div>
                          <div class="form-group row col-12">
                            <label class="col-md-4">Catatan Pengajuan</label>
                            <div class="col-8">
                              <textarea name="transaksi_detail_catatan[]" id="transaksi_detail_catatan_<?= $key ?>" cols="3" rows="3" class="form-control disabled" placeholder="Untuk kebutuhan Extra Cek Pabrik NPK 5"><?= $detail['transaksi_detail_catatan'] ?></textarea>
                            </div>
                          </div>
                        </div>
                        <!-- Kiri -->
            ...
            <div class="card-footer">
              ...
              <?php if ($this->input->get('status') == '3') : ?>
                <button type="button" class="btn btn-custom btn-success float-right" id="disposisi_avp">Disposisi AVP</button>
              <?php elseif ($this->input->get('status') == '4') : ?>
                <button type="button" class="btn btn-custom btn-success float-right" id="disposisi_seksi">Disposisi Seksi</button>
              <?php else : ?>
                <button type="button" class="btn btn-custom btn-success float-right" id="disposisi_seksi_chemlat">Disposisi Seksi</button>
              <?php endif ?>
          ...
          <table id="table_disposisi" class="table table-bordered table-striped " width="100%">
            <thead>
              <tr>
                ...
                <th>Foto Sample</th>
                <th class="text-center" width="200">Disposisi AVP</th>
              </tr>
            </thead>
          </table>
        </div>
...
<!-- modal disposisi seksi -->
<div class="modal fade" id="modal_disposisi_seksi" data-backdrop="false">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <table id="table_disposisi_seksi_chemlat" class="table table-bordered table-striped table_disposisi_seksi_chemlat" width="100%">
            <thead>
              <tr>
                ...
                <th>Parameter Sample</th>
                <th>Foto Sample</th>
                <th width="200">Disposisi Seksi</th>
                <th width="180">Petugas Sampling</th>
                <th width="30">Tanggal Sampling</th>
              </tr>
            </thead>
          </table>
        </div>
