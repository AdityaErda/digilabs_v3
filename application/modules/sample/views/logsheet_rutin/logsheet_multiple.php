...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <form id="form_logsheet_multiple" method="POST" action="<?= base_url() ?>sample/nomor/insertLogsheetMultiple">
            <!-- Detail Sample -->
            <div class="card">
              <!-- Header -->
                    ...
                    <div class="col-6">
                      <div class="form-group row col-md-12">
                        ...
                        <div class="input-group date col-md-8">
                          <input name="transaksi_tanggal_terima" id="transaksi_tanggal_terima" class="datetimepicker form-control" type="text" inputmode="none" required="" value="<?= $nomor['when_create'] ?>" readonly>
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group date col-md-8">
                          <input name="transaksi_tanggal_uji" id="transaksi_tanggal_uji" class="datetimepicker form-control" type="text" inputmode="none" required="">
                          <span class="input-group-text">
                            <span class="fa fa-calendar"></span>
                          </span>
                        </div>
                      ...
                      <div class="form-group row col-12">
                        ...
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_asal" name="transaksi_asal" placeholder="Asal sample" value="" required>
                        </div>
                      </div>
                      <div class="form-group row col-12">
                        <label class="col-md-4">Penerima Sample</label>
                        <div class="input-group col-md-8">
                          <input type="text" class="form-control" id="transaksi_penerima" name="transaksi_penerima" placeholder="Penerima Sample" value="" required>
                        </div>
                      </div>
                      <div class="form-group row col-12">
            ...
            <!-- Transaksi Detail -->
            <?php foreach ($nomor_all as $key => $value) : ?>
              <?php
