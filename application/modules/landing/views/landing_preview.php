...
<html lang="en">
  ...
  <?php
    $sql = $this->db->query("SELECT * FROM landing.landing ORDER BY landing_urut ASC");
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
              <form action="" method="get">
                <input type="text" name="transaksi_nomor" class="form-control" value="<?= (isset($_GET['transaksi_nomor'])) ? $_GET['transaksi_nomor'] : ''; ?>" required><input type="submit" value="Cari">
              </form>
            </div>
            <p>&nbsp;</p>
            <hr>
            <?php if (isset($_GET['transaksi_nomor'])): ?>
              <?php
                $sql = $this->db->query("SELECT * FROM sample.sample_transaksi a LEFT JOIN sample.sample_transaksi_detail b ON a.transaksi_id = b.transaksi_id LEFT JOIN sample.sample_peminta_jasa d ON d.peminta_jasa_id = b.peminta_jasa_id LEFT JOIN sample.sample_jenis q ON q.jenis_id = b.jenis_id WHERE UPPER(transaksi_nomor) LIKE '%".$_GET['transaksi_nomor']."%' AND (is_proses != 'y' OR is_proses is NULL) ORDER BY a.transaksi_nomor ASC");
                  ...
                  <?php if ($dataSample): ?>
                    <?php foreach ($dataSample as $value): ?>
                      ...
                      <tr>
                        ...
                        <!-- <td align="center"><a href="javascript:;"><i class="bi bi-repeat"></i></a></td> -->
                        <!-- <td align="center"><a href="javascript:;"><i class="bi bi-search"></i></a></td> -->
                      </tr>
                    <?php endforeach ?>
                  <?php endif ?>
                </tbody>
