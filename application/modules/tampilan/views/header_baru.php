...
<head>
  ...
  <!-- <script src="<?=site_url('assets_tambahan/jQuery/jquery-3.6.0.min.js')?>"></script> -->
  <!-- jQuery -->
  ...
  <!-- Google Font: Source Sans Pro -->
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/DataTables/css/dataTables.bootstrap5.min.css') ?>">
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/Responsive/css/responsive.bootstrap5.min.css') ?>">
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/Buttons/css/buttons.bootstrap5.min.css') ?>">
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/FixedHeader/css/fixedHeader.bootstrap5.min.css') ?>">
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/FixedColumns/css/fixedColumns.bootstrap5.min.css') ?>">
  <link rel="stylesheet" href="<?php echo site_url('assets_tambahan/datatables-bs5/Scroller/css/scroller.bootstrap5.min.css') ?>">
...
<!--   <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  ...
  <!-- Bootstrap 5 -->
  <link rel="stylesheet" href="<?=site_url('assets_tambahan/bootstrap-5/css/bootstrap.min.css')?>">
  <script src="<?php echo site_url('assets_tambahan/bootstrap-5/js/bootstrap.bundle.min.js') ?>"></script>
  <!-- Bootstrap 5 -->
  ...
  <script src="<?=site_url('assets_tambahan/datatables-bs5/DataTables/js/dataTables.bootstrap5.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Responsive/js/dataTables.responsive.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Responsive/js/responsive.bootstrap5.min.js')?>"></script>

  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/dataTables.buttons.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/buttons.bootstrap5.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/buttons.html5.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/buttons.print.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/buttons.colVis.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Buttons/js/buttons.jqueryui.min.js')?>"></script>
  
  <script src="<?=site_url('assets_tambahan/datatables-bs5/FixedHeader/js/dataTables.fixedHeader.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/FixedHeader/js/fixedHeader.bootstrap5.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/FixedColumns/js/dataTables.fixedColumns.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/FixedColumns/js/fixedColumns.bootstrap5.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Scroller/js/dataTables.scroller.min.js')?>"></script>
  <script src="<?=site_url('assets_tambahan/datatables-bs5/Scroller/js/scroller.bootstrap5.min.js')?>"></script>
...
<!--   <script src="<?= base_url() ?>assets/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js"></script>
  ...
  <style type="text/css">
    ...
    #loader {
      ...
      height: 100%;
      z-index: 9999;
      background: url('<?php echo site_url('assets_tambahan/ext_img/loading_page_resize_2.gif') ?>') 50% 50% no-repeat rgb(249, 249, 249);
      }
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="#" onclick="return logout()"><i class="fas fa-power-off" title="Log Out"></i></a>
        </li>
      </ul>
      <!-- navbar kanan -->
    </nav>
