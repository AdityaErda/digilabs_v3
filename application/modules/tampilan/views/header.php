...
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible Content-Security-Policy" content="IE=edge script-src 'none'">
  <title><?= $judul ?></title>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>assets/plugins/jquery-autocomplete/jquery.autocomplete.css">
  ...
  <script src="<?= base_url() ?>assets_tambahan/pdfjs/build/pdf.js"></script>
  <script src="<?= base_url() ?>assets_tambahan/pdfjs/web/viewer.js"></script>
  <script>
    $(function() {
      /* jQueryKnob */
      $('.knob').knob({
  ...
  <style type="text/css">
    ...
    #loader {
      ...
      background: url('<?= base_url('assets_tambahan/ext_img/loading_bar.webp') ?>');
