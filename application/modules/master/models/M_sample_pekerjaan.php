	...
	class M_sample_pekerjaan extends CI_Model {
		...
		/* INSERT IMPORT */
			...
			public function insertTable($data) {
				$this->db->query("INSERT INTO sample.sample_pekerjaan SELECT sample_pekerjaan_id, sample_pekerjaan_kode, sample_pekerjaan_nama, when_create, who_create FROM import.import_sample_pekerjaan WHERE import_kode = '".$data['import_kode']."' AND UPPER(sample_pekerjaan_nama) NOT IN (SELECT UPPER(sample_pekerjaan_nama) FROM sample.sample_pekerjaan)");
