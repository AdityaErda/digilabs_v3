...
<body>
  ...
  <div id="cetakan">
    <table style="border-collapse: collapse;" border="1" width="100%" class="tabel tabel-berwarna" id="tabel">
...
<script type="text/javascript" src="<?= base_url() ?>/assets_tambahan/excellentexport-master/dist/excellentexport.js"></script>
...
<script>
  function excel() {
    $('.tabel').table2excel({
      exclude: ".noExl",
      name: "tabel",
      filename: "Template Single - <?= $template['template_logsheet_nama'] ?>",
      fileext: ".xls",
      exclude_img: true,
      exclude_links: true,
      exclude_inputs: true,
