<script type="text/javascript">
      ...
      initComplete: function () {
        ...
        "ajax": {
          ...
          "columns": [
            ...
            {"render": function ( data, type, full, meta ) {
              return '<center><a href="javascript:;" id="'+full.peminta_jasa_id+'" title="Edit" onclick="fun_edit(this.id)"><i class="fa fa-edit" data-toggle="modal" data-target="#modal" style="color: orange"></i></a></center>';
              }
            },
            {"render": function ( data, type, full, meta ) {
              return '<center><a href="javascript:;" id="'+full.peminta_jasa_id+'" title="Edit" onclick="fun_delete(this.id)"><i class="fa fa-trash" style="color: red"></i></a></center>';
              }
            },
          ]
      });
  ...
  /* View Update */
    function fun_edit(id) {
      ...
      $.getJSON('<?= base_url('master/peminta_jasa/getPemintaJasa') ?>', {peminta_jasa_id: id}, function(json) {
  ...
  /* Fun Delete */
    function fun_delete(id) {
      ...
      $.confirmModal('Apakah anda yakin akan menghapusnya?', function(el) {
        $.get('<?= base_url('master/peminta_jasa/deletePemintaJasa') ?>', {peminta_jasa_id: id}, function(data) {
          $('#close').click();
          toastr.success('Berhasil');
        });
      });
