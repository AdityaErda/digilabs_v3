                ...
                <div class="modal fade" id="modal">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <form id="form_modal">
                        <input type="text" id="audit_kategori_id" name="audit_kategori_id" value="" style="display: none;">
                        <div class="modal-body">
                          <div class="card-body row">
                            <div class="col-12">
                              <div class="form-group row col-md-12">
                                <label class="col-md-4">Nama Kategori Audit</label>
                                <div class="input-group col-md-8">
                                  <input type="text" class="form-control" id="audit_kategori_nama" name="audit_kategori_nama" value="" placeholder="Nama Kategori Audit">
                                </div>
                              </div>
