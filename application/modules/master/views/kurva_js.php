      ...
      "columns": [{
        ...
        },
        {
          "render": function(data, type, full, meta) {
            ...
            tombol += '<a class="dropdown-item" href="<?= base_url('master/kurva/lihat?id_kurva=') ?>' + full.kurva_id + '&header_menu=<?= $this->input->get('header_menu') ?>&menu_id=<?= $this->input->get('menu_id'); ?>" target="_blank">Lihat</a>';
