                ...
                <div class="modal fade" id="modal">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <form id="form_modal">
                        <input type="text" id="penyimpanan_id" name="penyimpanan_id" value="" style="display: none;">
                              ...
                              <div class="form-group row col-md-12">
                                <label class="col-md-4">Aset</label>
                                    <div class="input-group col-md-8">
                                        <select class="form-control select2" id="penyimpanan_aset" name="penyimpanan_aset"></select>
                                    </div>
                              </div>
                              <div class="form-group row col-md-12">
                                <label class="col-md-4">Status</label>
                                    <div class="input-group col-md-8">
                                        <select class="form-control select2" id="penyimpanan_status" name="penyimpanan_status">
