                                ...
                                <div class="modal fade" id="modal">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form id="form_modal">
                                                <input type="text" id="keterangan_sertifikat_id" name="keterangan_sertifikat_id" value="" style="display: none;">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row col-md-12">
                                                                ...
                                                                <div class="input-group col-md-8">
                                                                    <input type="text" class="form-control" id="keterangan_sertifikat_isi" name="keterangan_sertifikat_isi" value="" required="" placeholder="Isi Keterangan">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
