          ...
          <div class="col-md-12">
            <div class="card card-success">
              ...
              <div class="card-header">
                ...
                <a href="<?= base_url('material/transaksi_in/proses') ?>?header_menu=<?= $_GET['header_menu'] ?>&menu_id=<?= $_GET['menu_id'] ?>&transaksi_id=<?= create_id() ?>&aksi=1" class="btn btn-primary float-right">Tambah</a>
              </div>
              <!-- Header -->
              <!-- Body -->
              <div class="card-body">
                ...
                <!-- Modal -->
                <!-- Modal -->
                <div class="modal fade" id="modal_aksi_batal">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title"><?= $judul ?></h4>
                      ...
                      <form id="form_modal_batal">
                        <div class="modal-body">
                          <div class="form-group row col-md-12">
                            <input style="display:none" type="text" id="id_transaksi_batal" name="id_transaksi_batal">
                            <label class="col-md-4">Alasan Pembatalan</label>
                            <div class="input-group col-md-12">
                              <input type="text" class="form-control float-right" id="batal_alasan" name="batal_alasan">
                            </div>
                          </div>

                        </div>
                        <div class="modal-footer justify-content-between">
                          <button type="button" id="close_batal" onclick="fun_close()" class="btn btn-default" data-dismiss="modal">Close</button>
                          <button type="submit" class="btn btn-success" id="batal">Simpan</button>
                          <button class="btn btn-primary" type="button" id="loading_form_batal" disabled style="display: none;">
                            <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                            Loading...
                          </button>
                        </div>
