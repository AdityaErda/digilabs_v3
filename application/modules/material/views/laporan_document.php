                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-3">
                      <label class="col-md-12">Tanggal Terbit Awal</label>
                    ...
                    <div class="form-group col-md-3">
                      <label class="col-md-12">Tangal Terbit Akhir</label>
          ...
          <div class="col-md-12">
            <div class="card card-success">
              ...
              <div class="card-header">
                ...
                <button onclick="func_cetak()" class="btn btn-danger float-right">Cetak</button>
              </div>
              <!-- Header -->
              <!-- Body -->
              <div class="card-body">
