...
class M_daftar extends CI_Model
{
	...
	// // start aprove pengajuan dokumen
	// public function updatepengajuan($data=null,$id){
	// 	$this->db->set($data)->where('transaksi_id',$id)->update('document.document_transaksi');
	// }
	// // end aprove pengajuan dokumen

	// // start tolak pengajuan dokumen
	// public function tolakpengajuan($data=null,$id){
	// 	$this->db->set($data)->where('transaksi_id',$id)->update('document.document_transaksi');
	// }
	// // end tolak pengajuan dokumen
	...
	// start data pengajuan
	// public function getDataPengajuanDetail($data=null){
	// 	$this->db->select("a.transaksi_id, a.transaksi_judul_document,a.transaksi_keterangan_document,concat_ws('<br/><br/>',a.transaksi_file_word,a.transaksi_file_pdf) as transaksi_filenya ,a.transaksi_file_word,a.transaksi_file_pdf,jenis_nama,a.jenis_id,a.seksi_id,seksi_nama,to_char(transaksi_tgl_pengesahan,'DD-MM-YYYY') as transaksi_tgl_pengesahan,transaksi_revisi,transaksi_terbitan,transaksi_keterangan_document,transaksi_nomor_document,transaksi_status,a.transaksi_file,
	// 	case
	// 	when transaksi_status = '0' then 'pengajuan'
	// 	when transaksi_status = '1' then 'aprove'
	// 	when transaksi_status = '2' then 'ditolak'
